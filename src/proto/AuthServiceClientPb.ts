...
export class AuthServiceClient {
  ...
  methodDescriptorCheckAuth = new grpcWeb.MethodDescriptor(
    ...
    proto_auth_pb.AuthResponse,
    (request: proto_auth_pb.EmptyAuth) => {
      return request.serializeBinary();
    },
    proto_auth_pb.AuthResponse.deserializeBinary
  );

  checkAuth(
    request: proto_auth_pb.EmptyAuth,
    metadata?: grpcWeb.Metadata | null): Promise<proto_auth_pb.AuthResponse>;

  checkAuth(
    request: proto_auth_pb.EmptyAuth,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.RpcError,
               response: proto_auth_pb.AuthResponse) => void): grpcWeb.ClientReadableStream<proto_auth_pb.AuthResponse>;

  checkAuth(
    request: proto_auth_pb.EmptyAuth,
    metadata?: grpcWeb.Metadata | null,
    callback?: (err: grpcWeb.RpcError,
               response: proto_auth_pb.AuthResponse) => void) {
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ +
          '/pb.AuthService/CheckAuth',
